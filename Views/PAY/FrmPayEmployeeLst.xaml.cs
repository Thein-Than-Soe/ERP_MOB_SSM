...
namespace CS.ERP_MOB.Views.PAY
{
    ...
    public partial class FrmPayEmployeeLst : ContentView
    {
        #region "Declaring"
        VmlEmployee mVmlEmployee;
        #endregion
        #region "Constructor"
        public FrmPayEmployeeLst()
        {
            try
            {
                InitializeComponent();
                    ...
                    case "1"://English
                        {
                            ...
                            TabAll.Text = "Supervision (" + mVmlEmployee.EmployeeSupervisionList.Count + ")";
                        }
                        break;
                    case "2"://Myanmar
                        {
                            ...
                            TabSelf.Text = "Self (" + mVmlEmployee.SelfEmployeeList.Count + ")";
                            TabRO.Text = "RO (" + mVmlEmployee.EmployeeROList.Count + ")";
                            TabAll.Text = "ကြီးကြပ်ကြည့်ရှုသူ (" + mVmlEmployee.EmployeeSupervisionList.Count + ")";
