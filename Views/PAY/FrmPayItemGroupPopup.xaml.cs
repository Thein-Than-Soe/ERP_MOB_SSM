...
namespace CS.ERP_MOB.Views.PAY
{
    ...
    public partial class FrmPayItemGroupPopup : Popup
    {
        #region "Declaring"
        VmlEmployee mVmlEmployee;
        DAT_ITEM_GROUP_DETAIL DAT_ITEM_GROUP_DETAIL = new DAT_ITEM_GROUP_DETAIL();
        #endregion
        #region "Constructor"
        public FrmPayItemGroupPopup()
        {
            try
            {
                InitializeComponent();
        ...
        private void grdView_ItemSelected(object sender, SelectedItemChangedEventArgs e)
        {
            try
            {
                var l_DAT_ITEM_GROUP_DETAIL = (DAT_ITEM_GROUP_DETAIL)e.SelectedItem;
                if (l_DAT_ITEM_GROUP_DETAIL != null)
                {
