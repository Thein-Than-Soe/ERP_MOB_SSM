...
namespace CS.ERP_MOB.Views.HCM
{
    ...
    public partial class FrmHcmEmployeeLst : ContentView
    {
        #region "Declaring"
        VmlEmployee mVmlEmployee;
        #endregion
        #region "Constructor"
        public FrmHcmEmployeeLst()
        {
            try
            {
                InitializeComponent();
