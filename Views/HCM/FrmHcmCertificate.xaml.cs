...
namespace CS.ERP_MOB.Views.HCM
{
    ...
    public partial class FrmHcmCertificate : ContentPage
    {
        #region "Declaring"
        ...
        private void okClick(object sender, EventArgs e)
        {
            try
            {
                ...
                Common.routeMenu(Common.mCommon.SelectedMenu, DAT_APPLICANT_CERTIFICATE.InstituteName, DAT_APPLICANT_CERTIFICATE.CertificateName, DAT_APPLICANT_CERTIFICATE.InstituteName);
