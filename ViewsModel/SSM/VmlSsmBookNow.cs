...
namespace CS.ERP_MOB.ViewsModel.SSM
{
    public class VmlSsmBookNow : BaseViewModel
    {
        ...
        //user added list
        private ObservableCollection<RES_SALE_PAYMENT> mPaymentList = new ObservableCollection<RES_SALE_PAYMENT>();
        ...
        private async Task loadBookNowInternal()
        {
            try
            {
                mRequest = JsonConvert.SerializeObject(Common.mCommon.REQ_AUTHORIZATION);
        ...
        private async Task getAvailableUserInternal()
        {
            try
            {
                mJSN_REQ_AVAILABLE_USER.REQ_AUTHORIZATION = Common.mCommon.REQ_AUTHORIZATION;
