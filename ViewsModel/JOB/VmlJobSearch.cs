    ...
    public class VmlJobSearch : BaseViewModel
    {
...

        {
            try
            {
                ...
                mResponse = await Job_Service.ApiCall(mRequest, Job_Name.wsgetJobSearch);
        ...
        public async void saveJobVacancy(DAT_APPLICANT_VACANCY_JUN arg_DAT_APPLICANT_VACANCY_JUN)
        {
            try
            {
                ...
                mResponse = await Job_Service.ApiCall(mRequest, Job_Name.wssaveApplicantVacancy);
                if (mResponse != null && mResponse != "")
                {
        ...
        public async void loadJobVacancy()
        {
            try
            {
                ...
                mResponse = await Job_Service.ApiCall(mRequest, Job_Name.wsLoadJobVacancy);
                if (mResponse != null && mResponse != "")
                {
